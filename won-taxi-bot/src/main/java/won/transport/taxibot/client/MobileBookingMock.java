...
public class MobileBookingMock implements MobileBooking{
    ...
    public Result getFleetRadar() {
        Result result = new Result();
        won.transport.taxibot.client.entity.Parameter.Error error = new won.transport.taxibot.client.entity.Parameter.Error();
        error.setType(1);
        error.setId(1);
    ...
    public Result getServiceList(State state, PostCode postCode) {
        Result result = new Result();
        won.transport.taxibot.client.entity.Parameter.Error error = new Error();
        error.setType(1);
        error.setId(1);
        error.setText("NOT IMPLEMENTED IN MOCK");
        result.setError(error);
