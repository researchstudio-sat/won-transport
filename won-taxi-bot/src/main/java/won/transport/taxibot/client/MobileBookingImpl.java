...
import won.transport.taxibot.client.entity.Function;
...
public class MobileBookingImpl implements InitializingBean, MobileBooking{
    private static final Logger logger = LoggerFactory.getLogger(MobileBookingImpl.class);
